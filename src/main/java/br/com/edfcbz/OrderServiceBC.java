...
import br.com.edfcbz.api.enumeration.OrderStatusDomainEnum;
...
public class OrderServiceBC implements IService<OrderTO> {
	...
	private void saveOrderStatus(OrderTO orderTO) {
		OrderStatusDomainTO orderStatusDomainTO = orderStatusDomaninDAO.findByName(OrderStatusDomainEnum.RECEIVED_BY_SYSTEM.getDescricao()).get(0) ; 		
