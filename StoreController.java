...
public class StoreController {
	...
	@Autowired
	private ProductStoreListService productStoreListService;
	...
	@ApiOperation(value = "Find a specific Address by your ID" )
	@GetMapping(value = "/{id}/product", produces = { "application/json", "application/xml", "application/x-yaml" })
	public List<ProductStoreListVO> findProductByStoreId(@PathVariable("id") int id) {
		List<ProductStoreListVO> list = productStoreListService.findProductByStoreId(id);
		return list ;			
	}	
